...
describe Seedbank::DSL do
  ...
  describe "scope_from_seed_file" do
    ...
    describe "in an environment directory" do
      ...
      let(:seed_file) { File.expand_path('development/users.rb', Seedbank.seeds_root) }
    ...
    describe "in a nested directory" do
      ...
      let(:seed_file) { File.expand_path('development/shared/accounts.rb', Seedbank.seeds_root) }
    ...
    describe "in seeds root" do
      ...
      let(:seed_file) { File.expand_path('no_block.rb', Seedbank.seeds_root) }
